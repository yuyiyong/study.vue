<!--
 * @LastEditors: yyy_dui
 * @LastEditTime: 2021-03-10 14:55:03
...
export default {
  ...
  mounted: function () {
    this.$nextTick(function () { // 等到整个视图都渲染完毕 该钩子在服务器端渲染期间不被调用。
  ...
  beforeUpdate: function () {
    console.log('beforeUpdate ' + '22222222')
  },
  updated: function () {
    console.log('updated ' + '22222222')
  },
  activated: function () {
    console.log('activated ' + '22222222')
  },
