<!--
 * @LastEditors: yyy_dui
 * @LastEditTime: 2021-03-10 15:23:27
...
<template>
  <div>
    ...
    <el-button v-bind:disabled="btnDisable">Button 绑定当中的disabled</el-button>
    <el-button v-bind:disabled="btnDisable" v-on:click='btnDisable=!btnDisable'>{{btnDisable?'解封':'封闭'}}</el-button>
  </div>
</template>
